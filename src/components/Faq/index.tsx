    ...
    <section className="relative z-20 overflow-hidden bg-white pb-8 pt-20 dark:bg-dark lg:pb-[50px] lg:pt-[120px]">
      <div className="container">
        <SectionTitle
          ...
          paragraph="MeetWise is designed to simplify meetings, ensuring your team stays aligned and productive. Here are answers to some common questions."
          width="640px"
          center
        />
        ...
        <div className="-mx-4 mt-[60px] flex flex-wrap lg:mt-20">
          <div className="w-full px-4 lg:w-1/2">
            <SingleFaq
              question="How does MeetWise work?"
              answer="MeetWise transcribes and summarizes your meetings automatically, providing you with clear action items and key takeaways to keep your team on track."
            />
            <SingleFaq
              question="Which video conferencing platforms are supported?"
              answer="MeetWise seamlessly integrates with Zoom, Microsoft Teams, Google Meet, Go Meeting and other popular platforms for effortless meeting summarization."
            />
            <SingleFaq
              question="Can I customize action items in MeetWise?"
              answer="Yes, you can tailor action items from meeting summaries to match your team's workflow and ensure tasks are assigned and tracked effectively."
            />
          </div>

          <div className="w-full px-4 lg:w-1/2">
            <SingleFaq
              question="Is MeetWise for commercial use?"
              answer="Absolutely! MeetWise is built to enhance productivity for businesses of all sizes by providing clear, actionable meeting insights."
            />
            <SingleFaq
              question="Do you offer a premium version of MeetWise?"
              answer="We are working on a Pro version of MeetWise with advanced features, coming soon to enhance your meeting management."
            />
            <SingleFaq
              question="Where can I host MeetWise On Internet?"
              answer="MeetWise is a cloud-based tool, so there's no need for hosting. Simply sign up and start using it directly from your browser."
            />
          </div>
        </div>
      </div>
