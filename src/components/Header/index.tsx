          ...
          <div className="relative -mx-4 flex items-center justify-between">
            <div className="w-60 max-w-full px-4">
              <Link href="/" className={`navbar-logo block w-full ${sticky ? "py-2" : "py-5"} `}>
                <>
                  <span className={`${sticky && pathUrl === '/' && 'text-slate-700'} ${!sticky && pathUrl === '/' && 'text-white'} ${pathUrl !== '/' && 'text-slate-700'} header-logo w-full text-3xl  font-semibold dark:hidden`}>
                    MeetWise
                  </span>
                  <span className="header-logo w-full text-3xl text-white font-semibold hidden dark:block">
                    MeetWise
                  </span>
                </>
              </Link>
